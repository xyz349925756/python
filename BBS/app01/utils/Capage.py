...
class Pagination(object):
    ...
    def __init__(self, current_page, all_count,per_page_num,pager_count):  #, per_page_num, pager_count
        """
        封装分页相关数据
    ...
    def page_html(self):
        ...
        if self.all_pager <= self.pager_count:  # 所有页面 小于 最多显示页码
            pager_start = 1
